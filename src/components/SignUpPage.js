...
{error && <p className="text-danger">{typeof error === 'string' ? error : 'An error occurred'}</p>}
					...
					<button className=" text-slate-100 text-2xl mt-2 rounded-md mb-4 d-block mx-auto fixed-action-btn btn-primary bg-blue-800"
